...
redirect = "127.0.0.1"  # redirect to this address
...
while True:
    if dt(dt.now().year, dt.now().month, dt.now().day, 8) < dt.now() < dt(dt.now().year, dt.now().month, dt.now().day,
        ...
        print("Working hours.....")  # if statement is true output string
        ...
        print("Recreation hours...")  # if false output string
